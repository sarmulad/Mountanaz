        ...
        <div className='features'>
            ...
            <div className='container'>
                ...
                <div className='right'>
                    ...
                    <h2>Scalability</h2>
                    <p>Most existing DeFi projects hit a scaling roadblock they couldn't escape. Every transaction must be made public and recorded on the blockchain for blockchain technology to work. This restricts the number of transactions that may be completed at any one moment. Mountanaz is built on a blockchain technology that processes numerous transactions quickly.</p>
                </div>
